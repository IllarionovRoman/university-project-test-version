...
export const STUDENT_CREATE_REQUEST = 'STUDENT_DELETE_REQUEST'
export const STUDENT_CREATE_SUCCESS = 'STUDENT_DELETE_SUCCESS'
export const STUDENT_CREATE_FAIL = 'STUDENT_DELETE_FAIL'
export const STUDENT_CREATE_RESET = 'STUDENT_DELETE_RESET'
